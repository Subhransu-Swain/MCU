...
void HAL_RCC_MCOConfig(uint32_t RCC_MCOx, uint32_t RCC_MCOSource, uint32_t RCC_MCODiv)
{
  ...
  if(RCC_MCOx == RCC_MCO1)
  {
    ...
    subhransu.Pin = MCO1_PIN;
    subhransu.Mode = GPIO_MODE_AF_PP;
    subhransu.Speed = GPIO_SPEED_FREQ_VERY_HIGH;
    subhransu.Pull = GPIO_NOPULL;
    subhransu.Alternate = GPIO_AF0_MCO;
    HAL_GPIO_Init(MCO1_GPIO_PORT, &subhransu);
  ...
  else
  {
    ...
    subhransu.Pin = MCO2_PIN;
    subhransu.Mode = GPIO_MODE_AF_PP;
    subhransu.Speed = GPIO_SPEED_FREQ_VERY_HIGH;
    subhransu.Pull = GPIO_NOPULL;
    subhransu.Alternate = GPIO_AF0_MCO;
    HAL_GPIO_Init(MCO2_GPIO_PORT, &subhransu);
